...
<template>
  <div
    class="blueprint-container p-5 bg-[#147aff1a] dark:bg-darkBackground mt-8 rounded-md"
  >
    ...
    <transition name="fade">
      <div :class="blueprintEnable ? 'block' : 'hidden'">
        <div
          class="blueprint-items grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4"
        >
