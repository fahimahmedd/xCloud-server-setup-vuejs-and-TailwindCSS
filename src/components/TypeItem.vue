...
const serverTypeList = [
  ...
  },
  {
    ...
    value: "staging",
    text:
      "Create your site in a staging environment and refine it until it’s ready for launch.",
  },
];
...
<template>
  <h5 class="text-gray-800 dark:text-white text-md dark:font-light font-medium mt-8">Server Type</h5>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-8 mt-2">
    ...
    >
      ...
      >
        ...
        <div class="pl-5">
          <h4 class="text-gray-800 dark:text-white">{{ item.title }}</h4>
          <p class="text-sm leading-5 mt-1 line-clamp-2 text-darkText font-light">
            {{ item.text }}
          </p>
        </div>
      </label>
