  ...
  >
    ...
    <form>
      <div class="server-details mt-10">
        <h5 class="text-gray-800 dark:text-white text-md font-medium">
          Server Details
        </h5>
        <div
          class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-8 mt-2"
        >
          <div>
          ...
          <div>
            <label
              class="font-light text-sm text-gray-700 dark:text-darkText"
              for="title"
